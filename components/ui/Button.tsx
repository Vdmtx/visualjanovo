...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary: 'bg-primary-cyan text-light-text hover:bg-accent-purple focus:ring-primary-cyan',
  ...
  return (
    ...
    >
      {loading ? (
        <svg className="animate-spin h-5 w-5 text-dark-background-start" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
